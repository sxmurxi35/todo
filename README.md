# Todo App (Webpack & ES6 Study)

A modular task management application built with Vanilla JavaScript. This project was designed to master the modern frontend workflow and build tools.

**Status: Work in Progress** 

## Key Features
* Modular Architecture: Organized with ES6 modules for clean and maintainable code.
